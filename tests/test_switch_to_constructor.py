...
class TestSwitchToConstructor:
    ...
    def test_success_sign_click_on_switch_to_constructor(self, driver):
        ...
        assert WebDriverWait(driver, 10).until(EC.visibility_of_element_located(Locators.PLACE_AN_ORDER))
